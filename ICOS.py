...
# Startwert für Daten
screencounter = QtWidgets.QDesktopWidget().screenCount()
print(screencounter)
...
class Moniindi(QWidget):
    """
    mointor indikator fenster
    """

    def __init__(self, *args, **kwargs):
        super(Moniindi, self).__init__(*args, **kwargs)
        uic.loadUi('ui/moniindi.ui', self)
        self.setWindowTitle('indikator')
        self.setWindowFlag(Qt.FramelessWindowHint, Qt.WindowStaysOnTopHint)
...
class MainWindow(QMainWindow):
    ...
    def audiowarnsignal(self):
        ...
        full_file_path = os.path.join(os.getcwd(), 'ui/sounds/sound.mp3')
